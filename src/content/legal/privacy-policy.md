...
When you contact us, fill out a form, send an inquiry, join a community channel, subscribe to updates, participate in a program, or communicate with us, we may collect:

1. name;
2. email address;
3. message content;
4. organization, entity, project, or community name;
5. inquiry type;
6. program interest;
7. partner, sponsor, or collaboration interest;
...
Submitting a form or inquiry does not automatically create acceptance, partnership, sponsorship, employment, membership, program registration, investment relationship, or any binding contract. Any such relationship must be confirmed by BANANOW through the relevant official process.
...
5. token or collection interaction;
6. chain or network information;
7. blockchain explorer data;
...
4. feedback;
5. session metadata;
6. model or provider selection;
7. interaction with curated memory, library, or knowledge sources if implemented;
8. usage logs needed for safety, abuse prevention, quality, and service improvement.

Claps and any AI-related feature should not be used to submit unnecessary sensitive personal data, especially data about children, health, family conflict, legal issues, emergency situations, precise addresses, financial details, identity documents, or other sensitive matters unless a specific feature clearly asks for it and provides an appropriate notice.

Claps is not a substitute for professional medical, psychological, legal, emergency, educational, or parenting support.
...
5. media, image, or file information;
6. contact details connected to publication, collaboration, correction, or takedown requests.

### 2.6. Skool and Program Data

If you interact with Skool Now or future program-related pages, we may process:

1. participant inquiry;
2. program interest;
3. schedule or location preference;
4. partner or sponsor information;
5. parent or guardian contact where relevant;
...
5. support Web3/NFT-related features and wallet-based interactions;
6. provide AI-related features if implemented;
7. improve safety, security, performance, and reliability;
8. prevent abuse, fraud, spam, scams, impersonation, or harmful activity;
9. understand usage patterns and improve user experience;
10. publish, manage, or moderate content;
...
Depending on your location and the applicable law, we may process Personal Data based on:
...
Withdrawal of consent may affect your ability to use certain features.
...
5. when required by law, regulation, legal process, court order, or government authority;
6. when necessary to enforce our Terms & Conditions or protect our rights;
7. when necessary to prevent fraud, abuse, security incidents, scams, or harm;
8. in connection with a merger, acquisition, restructuring, transfer, or continuation of BANANOW-related operations.

We do not control public blockchain networks, third-party marketplaces, wallet providers, social platforms, or external websites.
...
3. database and storage providers;
4. form providers;
5. email or contact providers;
6. wallet providers;
7. blockchain networks;
8. blockchain explorers;
9. NFT marketplaces;
10. payment providers if later used;
11. AI or model providers if later used;
12. social and community platforms;
13. documentation and code repository platforms.

Examples may include Base, Ethereum, Polygon, Tezos, BaseScan, EtherScan, PolygonScan, TZKT, OpenSea, OBJKT, MetaMask, thirdweb, GitBook, GitHub, Vercel, Web3Forms, Google, Discord, Instagram, X, and YouTube.
...
We are not responsible for the privacy practices of third-party websites, marketplaces, wallets, blockchain explorers, social platforms, or external services.
...
3. legal, accounting, security, or reporting requirements;
4. dispute resolution needs;
5. abuse, scam, or fraud prevention;
6. technical backup or archive cycles;
7. whether the information appears on public blockchain networks or third-party platforms.

We may retain de-identified, aggregated, or anonymized information for analytics, safety, research, reporting, or service improvement.

## 10. Security

We take reasonable precautions and use appropriate measures to help protect information from loss, misuse, unauthorized access, disclosure, alteration, or destruction.

However, no method of transmission over the Internet, blockchain, wallet infrastructure, or electronic storage is completely secure. We cannot guarantee absolute security.
...
Do not use general contact forms, AI chat, public community channels, or Web3/NFT pages to submit sensitive child data, medical data, legal documents, identity documents, precise addresses, or emergency information unless a specific official process clearly asks for it.
...
4. request a copy or export of Personal Data;
5. withdraw consent where processing is based on consent;
6. object to or restrict certain processing;
7. ask questions about how your Personal Data is collected, used, stored, or disclosed.
...
Some data may not be deleted or changed if it is:
...
## 13. De-Identified, Aggregated, or Anonymous Data

We may create de-identified, aggregated, or anonymized information from Personal Data by removing or limiting identifiers.
...
6. communicate general insights to partners, sponsors, or collaborators where appropriate.
