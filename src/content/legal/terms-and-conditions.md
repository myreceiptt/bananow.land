...
6. BANANOW NFT / Heads-related pages and Web3 experiences;
...
BANANOW BASED NFTs Minting Page:
`https://bananownfts.endhonesa.com/`

BANANOW BASED NFTs on BaseScan:
`https://land.endhonesa.com/basescan/`

BANANOW BASED NFTs on OpenSea:
`https://land.endhonesa.com/base/`

### 5.3. Historical / Legacy NFT Doors

Lord of BANANOW Collection on Ethereum (Deprecated Contract):
`https://land.endhonesa.com/lord/`

BANANOW Tree Collection on Ethereum (Deprecated Contract):
`https://land.endhonesa.com/tree/`

BANANOW NFTs Collection on Ethereum (Deprecated Contract):
`https://land.endhonesa.com/opensea/`

LadyME NFTs Collection on Tezos:
`https://land.endhonesa.com/ladyme/`

The ROTY BROI NFTs Collection on Polygon:
`https://land.endhonesa.com/rotybroi/`

Born2Burn NFTs Collection on Tezos:
`https://land.endhonesa.com/born2burn/`

Escapeace NOWART 1o1 NFTs Collection on Ethereum:
`https://land.endhonesa.com/escapeace/`

Historical, legacy, archived, or deprecated links are part of BANANOW’s roots, memory, and soil. They should not automatically be treated as current active programs, current official campaigns, current NFT instructions, or current official offers unless clearly stated by BANANOW through current official channels.

The banana may be playful. Your wallet should stay awake.
...
Please review third-party policies carefully before interacting with them.

Complaints, claims, concerns, or questions regarding third-party products, services, platforms, accounts, wallets, marketplaces, explorers, or transactions should be directed to the relevant third party.
...
1. general contact;
2. program interest;
3. Skool Now or future program registration or inquiry;
4. partner inquiry;
5. sponsor or investor inquiry;
6. community participation;
7. support or collaboration requests;
8. future Crop-specific activities.

Submitting a form, message, or inquiry does not automatically create acceptance, partnership, sponsorship, investment relationship, employment, membership, program registration, service contract, or any binding agreement.

Any such relationship must be confirmed by BANANOW in writing or through the relevant official process.

You are responsible for ensuring that the information you submit is accurate, lawful, and does not violate the rights of any third party.

## 8. Products, Services, Crops, and Programs

Certain products, services, Crops, programs, pages, or activities may be available exclusively online, through third-party platforms, through community channels, or through real-world activities.

We may modify, pause, discontinue, rename, archive, replace, or relaunch any Crop, program, product, service, or feature at any time.

Specific Crops, programs, campaigns, marketplace features, AI features, or real-world activities may have their own additional rules, requirements, pricing, schedules, eligibility, safety rules, refund rules, cancellation rules, waivers, consent requirements, or participation terms.

You should read and understand the specific information for each Crop, program, or activity before participating.

## 9. Skool Now and Program-Related Activities

Skool Now and future program-related activities may include education, workshops, hobbies, sports, community learning, real-world events, online sessions, or other program formats.

Program-specific terms may apply.

Unless clearly confirmed by BANANOW through an official process:

1. submitting a registration or inquiry does not mean acceptance into a program;
2. program schedules may change;
3. program locations may change;
4. program pricing may change;
5. refund and cancellation rules may differ by program;
6. safety rules and participation rules may apply;
7. guardian or parent consent may be required for minors;
8. BANANOW may reject, cancel, postpone, or limit participation where necessary for safety, capacity, operational, or community reasons.

Participation in physical, sports, hobby, or real-world activities may involve risks. Users, participants, parents, guardians, and partners are responsible for reading the specific program details and making appropriate decisions.
...
Claps and AI-related features are not:
...
5. emergency support;
6. a crisis service;
7. a substitute for professional help;
8. a substitute for parent, caregiver, teacher, or human judgment.

Users should not submit unnecessary sensitive personal data, especially data about children, health, family conflict, legal issues, identity documents, precise addresses, financial details, or emergencies.
...
1. price volatility;
2. total loss of value;
3. lack of demand;
4. lack of marketplace liquidity;
5. irreversible transactions;
6. gas fees and transaction fees;
7. failed transactions;
8. wallet compromise;
9. phishing and scams;
10. fake links or impersonation;
11. smart contract bugs;
12. metadata decay;
13. marketplace errors;
14. regulatory uncertainty;
15. third-party platform changes;
16. public and permanent blockchain records.

BANANOW does not guarantee:
...
11. floor price;
12. rarity value;
13. continued support by any third-party platform.

BANANOW NFT may be understood as a collectible, a community signal, an on-chain memory, a Web3 identity marker, and one of the ways people can carry the BANANOW symbol in the 0101 Universe. It is not a financial promise.

Do not buy, mint, sell, list, hold, or interact with any NFT or crypto item with an expectation of profit or guaranteed benefit.

You are solely responsible for:

1. your wallet;
2. your private key;
3. your seed phrase or recovery phrase;
4. your device security;
5. your transaction decisions;
6. your tax obligations;
7. your compliance with applicable laws;
8. verifying official links before interacting.

BANANOW will never ask for your private key or recovery phrase.

## 13. NFT Artwork and Intellectual Property License

Unless a specific NFT collection states otherwise in its own official terms, purchasing, receiving, or holding a BANANOW-related NFT does not transfer the underlying copyright, trademark, brand rights, source files, creative process, component images, technology, or other intellectual property rights to you.

Where applicable, NFT ownership may provide a limited, personal, non-exclusive, non-transferable or ownership-dependent license to display the associated artwork, subject to the specific terms of that NFT collection and marketplace.

Unless expressly allowed by specific collection terms, you may not:

1. claim ownership of BANANOW intellectual property;
2. register or attempt to register BANANOW marks, artwork, names, logos, or characters;
3. use BANANOW artwork to promote hatred, violence, harassment, discrimination, scams, illegal activity, or inappropriate behavior;
4. imply endorsement, partnership, sponsorship, or official status without written permission;
5. modify, commercialize, redistribute, or exploit BANANOW assets beyond what is expressly allowed.

If an NFT is transferred, sold, gifted, burned, or otherwise disposed of, any ownership-dependent license connected to that NFT may end automatically unless the specific collection terms state otherwise.

## 14. Historical, Legacy, or Deprecated NFT Contracts

BANANOW may have historical NFT contracts, legacy collections, earlier experiments, archived pages, deprecated contracts, or older marketplace links.

These may remain part of BANANOW’s memory, roots, and public history.

However, historical, legacy, or deprecated NFT links should not be treated as:

1. current active programs;
2. current official campaigns;
3. current minting instructions;
4. current marketplace instructions;
5. current support commitments;
...
NFTs or crypto items may be listed, sold, purchased, transferred, or displayed through third-party marketplaces, blockchain explorers, or future BANANOW-related marketplace features.

BANANOW does not control third-party marketplace listings, seller behavior, buyer behavior, pricing, marketplace availability, marketplace fees, royalties enforcement, wallet provider behavior, metadata rendering, or third-party platform decisions.

If BANANOW later provides its own marketplace or marketplace interface, specific marketplace terms, fees, royalty rules, transaction rules, and risk notices may apply.

Royalty, fee, or marketplace logic can only be enforced within systems, contracts, or transactions where such logic technically applies. BANANOW does not guarantee that all third-party marketplaces will honor royalties, fees, or collection preferences.
...
Community platforms may have their own terms, privacy policies, moderation rules, and account decisions.
...
9. to collect or track personal information of others;
10. to spam, phish, pharm, pretext, crawl, scrape, or exploit;
11. to promote scams, fake links, fake mints, fake marketplaces, or wallet-draining activity;
...
2. all links will always work;
3. all content will always be accurate, complete, or current;
4. all services will remain available;
5. all third-party platforms will remain available;
6. all blockchain data will render correctly;
7. all AI output will be accurate or suitable;
...
7. NFT value loss;
8. lack of NFT liquidity;
9. AI output;
10. program changes or cancellations;
11. social media or community platform actions;
12. unauthorized access;
13. loss of data;
14. lost profits, lost revenue, lost savings, or replacement costs;
15. scams, impersonation, fake links, or third-party solicitations.

Where some jurisdictions do not allow certain exclusions or limitations of liability, our liability will be limited to the maximum extent permitted by applicable law.

## 23. Indemnification

You agree to indemnify, defend, and hold harmless BANANOW, its Farmers, contributors, operators, partners, affiliates, officers, directors, employees, agents, contractors, service providers, licensors, and related parties from any claim or demand, including reasonable legal fees, arising out of or related to:
...
8. your participation in any Crop, program, community space, or Web3/NFT activity.

## 24. Severability

If any provision of these Terms is determined to be unlawful, void, or unenforceable, that provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed severed from these Terms.
...
These Terms and any separate agreements whereby BANANOW provides services shall be governed by and construed in accordance with the laws of the Republic of Indonesia, without prejudice to any mandatory consumer protection, privacy, or other non-waivable rights that may apply under applicable law.

The parties should first try to resolve any dispute through good-faith informal discussion and negotiation.

If a dispute cannot be resolved informally, it may be referred to and finally resolved by arbitration administered by BANI Arbitration Center under the applicable BANI rules, unless mandatory applicable law provides otherwise.

The seat of arbitration shall be Jakarta, Indonesia. The language of the arbitration shall be English, unless the parties agree otherwise.

Nothing in this section limits any non-waivable rights granted by applicable law.
