...
const products = [
  ...
  },
  {
    ...
    universe: "Reality",
    description:
      "Heads are BANANOW NFT holders and Web3 identity participants inside the BANANOW FAMILY. This collectible identity is a community signal, not an investment product or a promise of future financial return.",
    features: [
  ...
  },
  {
    ...
    universe: "Reality",
    description:
      "Farmers are caretakers who help keep BANANOW healthy, fair, and fun. Some may also be NFT holders, but Farmer work is about responsibility, care, and official coordination, not guaranteed revenue.",
    features: [
      "Caretaker Role",
      "Many of Many Users",
