  ...
  return (
    <div className="bg-white-now dark:bg-dark-now">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pt-20 pb-10">
        <h1 className="lg:text-4xl lg:font-extrabold text-3xl font-bold font-judul text-center text-neutral-900 dark:text-white">
      ...
      <div className="text-center pb-20">
        <Link onClick={sound2Click} href="/discord/" target="_blank">
          <button className="bg-green-now dark:bg-yellow-now text-neutral-900 dark:text-white rounded-full px-16 py-3 xl:text-base font-medium text-sm dark:hover:bg-white-now hover:bg-dark-now hover:text-white dark:hover:text-neutral-900">
            Immigration Check
          </button>
        </Link>
      </div>
