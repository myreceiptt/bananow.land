...
const ThemeSwitchOption = () => {
  ...
  return (
    <div
      onClick={sound0Click}
      className="inline-flex items-center border border-light-now hover:border-yellow-now rounded-md px-2 py-1">
      <svg
      ...
      <select
        className="bg-neutral-900 dark:bg-neutral-900 cursor-pointer text-lg rounded-md outline-none"
        value={theme}
        onChange={(e) => {
          sound3Click();
