      ...
      <div className="max-w-7xl mx-auto pt-32 pb-16 px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2">
        <div className="pt-6 sm:pt-8 justify-start sm:text-start">
          ...
          <p className="pt-6 text-base w-auto sm:w-10/12 md:w-10/12 text-dark-now dark:text-white-now">
            ...
            <br />
            <br />
            Yes, we know, Web3 this, Web3 that, Web3 her, Web3 him, Web3 they,
            what the freak is Web3, right?
            <br />
            <br />
            Take it easy,{" "}
            <span className="text-green-now dark:text-yellow-now font-bold">
            ...
            ! We're not going to push your limit knowing it, but we're here
            trying our best to show you that diving into the digital world can
            be as easy as peeling a{" "}
            <span className="text-yellow-now dark:text-green-now font-bold">
              BANANA
            </span>
            .<br />
            ...
            , together we've got your back. So, grab your lemon tea and join us
            for the most a-peeling adventure you'll ever have in the digital
            jungle!
            <br />
            <br />
            Let's grooowwww!!!!
          </p>
          <div className="flex flex-auto pt-10 gap-2 min-w-87.5 justify-start">
            <div>
              <Link
                onClick={sound2Click}
                href="#brandproducts"
