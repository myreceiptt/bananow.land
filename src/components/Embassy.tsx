    ...
    <div className="bg-white dark:bg-neutral-900" id="embassy">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 text-center">
        ...
        <p className="pt-6 pb-6 text-base max-w-2xl text-center m-auto text-dark-now dark:text-white-now">
          Want to contact us? Please choose an option below and we will be happy
          to respond to you with any information you need.
        </p>
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          <h2 className="text-lg font-judul font-bold text-neutral-900 dark:text-white">
            Contact{" "}
          ...
          <p className="max-w-sm mt-4 mb-4 text-dark-now dark:text-white-now">
            Have something to say? We are always here to respond. Fill up the
            form on the right to send an email or message us via our social
            network.
          </p>
          ...
          {!isSubmitSuccessful && (
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <button
                ...
                type="submit"
                className="w-full py-4 font-semibold transition-colors bg-dark-now dark:bg-white-now text-white dark:text-neutral-900 rounded-md hover:bg-green-now hover:text-neutral-900 dark:hover:bg-yellow-now dark:hover:text-white focus:outline-none focus:ring-offset-2 focus:ring focus:ring-neutral-200 px-7 cursor-pointer">
                {isSubmitting ? (
                  <svg
