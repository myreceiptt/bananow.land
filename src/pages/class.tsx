    ...
    <Layout>
      ...
      >
        ...
        <p className="pt-6 pb-16 text-base max-w-2xl text-center m-auto text-dark-now dark:text-white-now">
          Here you will find all the information about the <span className="text-green-now dark:text-yellow-now font-bold">BANANOW</span> Class held in both Universe of Reality, and 0101 Universe. Stay tuned!
        </p>
        <Image
