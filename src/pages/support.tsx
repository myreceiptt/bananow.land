  ...
  return (
    <Layout>
      <div
        ...
        id="404"
      >
        <h2 className="text-4xl font-bold text-center">Support Terms</h2>

        <p className="pt-6 pb-16 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          Here you can read all the information about the Support Terms of <span className="text-yellow-now">BANANOW</span>. Stay tuned!
        </p>
        <Image
