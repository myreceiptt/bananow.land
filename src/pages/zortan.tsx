...
export default function Redirect() {
  ...
  return (
    <Layout>
      <Head>
        <meta httpEquiv="Refresh" content="4; url='https://twitter.com/zortan_'" />
      </Head>
      <div
      ...
      >
        ...
        <p className="pt-6 pb-16 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          Redirecting to X account of ZORTAN, a farmers of <span className="text-yellow-now">BANANOW</span>...
        </p>
        <Image
        ...
        <div className="mt-16 text-center">
          ...
          <Link onClick={sound2Click} href="https://twitter.com/zortan_">
