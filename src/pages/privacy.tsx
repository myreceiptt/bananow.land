    ...
    <Layout>
      ...
      >
        ...
        <p className="pt-6 pb-16 text-base max-w-2xl text-center m-auto text-dark-now dark:text-white-now">
          Here you can read all the information about the Privacy Policy of <span className="text-green-now dark:text-yellow-now font-bold">BANANOW</span>. Stay tuned!
        </p>
        <Image
