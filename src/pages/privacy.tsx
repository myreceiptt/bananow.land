    ...
    <Layout>
      ...
      >
        ...
        <p className="pt-0 pb-16 text-base max-w-4xl text-left m-auto text-dark-now dark:text-white-now">
          OVERVIEW<br />
          <br />
          This website is operated by <span className="text-green-now dark:text-yellow-now font-bold">BANANOW</span> <span className="text-yellow-now dark:text-green-now font-bold">FAMILY</span>. Throughout the site, the terms “we”, “us” and “our” refer to <span className="text-green-now dark:text-yellow-now font-bold">BANANOW</span> <span className="text-yellow-now dark:text-green-now font-bold">FAMILY</span>, also referred to as <span className="text-green-now dark:text-yellow-now font-bold">BANANOW</span>.<span className="text-yellow-now dark:text-green-now font-bold">LAND</span> or <span className="text-green-now dark:text-yellow-now font-bold">BANANOW</span>. <span className="text-yellow-now dark:text-green-now font-bold">BANANOW</span> <span className="text-green-now dark:text-yellow-now font-bold">FAMILY</span> offers this website, including all information, tools, and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies, and notices stated here.<br />
          <br />
