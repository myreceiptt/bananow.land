  ...
  return (
    <Layout>
      <div
        ...
        id="404"
      >
        <h2 className="text-4xl font-judul font-bold text-center text-neutral-900 dark:text-white">90's Vibes</h2>

        <p className="pt-6 pb-16 text-base max-w-2xl text-center m-auto text-dark-now dark:text-white-now">
          Here you will find all the information about the 90's Vibes of <span className="text-green-now dark:text-yellow-now font-bold">BANANOW</span>. Stay tuned!
        </p>
        <Image
