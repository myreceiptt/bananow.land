  ...
  return (
    <Layout>
      <Head>
        <meta
          httpEquiv="Refresh"
          content="4; url='https://basescan.org/token/0xfd039ac57cc8e646802dba4b7cf6bc561e13a09a'"
        />
      </Head>
      <div
        ...
        <p className="pt-6 pb-16 text-base max-w-2xl text-center m-auto text-dark-now dark:text-white-now">
          ...
          NFTs smart contract on BaseScan.Org blockchain explorer...
        </p>
        <Image
        ...
        <div className="mt-16 text-center">
          ...
          <Link
            onClick={sound2Click}
            href="https://basescan.org/token/0xfd039ac57cc8e646802dba4b7cf6bc561e13a09a"
