...
export default function Base() {
  ...
  return (
    <Layout>
      <Head>
        <meta httpEquiv="Refresh" content="4; url='https://opensea.io/collection/bananow-based-nfts'" />
      </Head>
      <div
      ...
      >
        ...
        <p className="pt-6 pb-16 text-base max-w-2xl text-center m-auto text-dark-now dark:text-white-now">
          Redirecting to <span className="text-green-now dark:text-yellow-now font-bold">BANANOW BASED</span> NFTs collection on OpenSea.IO marketplace...
        </p>
        <Image
          src="/images/redirects/base.svg"
          alt="OpenSea.IO"
          width={1920}
          height={1080}
          quality={75}
        ...
        <div className="mt-16 text-center">
          ...
          <Link onClick={sound2Click} href="https://opensea.io/collection/bananow-based-nfts">
            <button className="bg-dark-now dark:bg-white-now text-white dark:text-neutral-900 text-base rounded-full px-16 p-3 font-medium dark:hover:bg-yellow-now hover:bg-green-now hover:text-neutral-900 dark:hover:text-white">
              BANANOW BASED NFTs on OpenSea.IO
            </button>
          </Link>
        </div>
      </div>
