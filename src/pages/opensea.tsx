    ...
    <Layout>
      ...
      >
        ...
        <p className="pt-6 pb-16 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          Redirecting to <span className="text-yellow-now">BANANOW</span> NFTs collection on OpenSea.IO marketplace...
        </p>
        <Image
        ...
        <div className="mt-16 text-center">
          ...
          <Link onClick={sound2Click} href="https://opensea.io/collection/bananow-nfts">
