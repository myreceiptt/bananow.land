    ...
    <Layout>
      ...
      >
        ...
        <p className="pt-6 pb-16 text-base max-w-2xl text-center m-auto text-dark-now dark:text-white-now">
          Redirecting to Instagram profile of <span className="text-green-now dark:text-yellow-now font-bold">BANANOW</span>...
        </p>
        <Image
          src="/images/redirects/instagram.svg"
        ...
        <div className="mt-16 text-center">
          <p className="pt-6 pb-16 text-base max-w-2xl text-center m-auto text-dark-now dark:text-white-now0">
