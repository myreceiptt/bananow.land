...
export default function BornBurn() {
  ...
  return (
    <Layout>
      <Head>
        <meta httpEquiv="Refresh" content="4; url='https://objkt.com/collection/KT1V87yvhDAq3cxgD92GoPZ4tT7UQvGbXsMp'" />
      </Head>
      <div
      ...
      >
        ...
        <div className="mt-16 text-center">
          ...
          <Link onClick={sound2Click} href="https://objkt.com/collection/KT1V87yvhDAq3cxgD92GoPZ4tT7UQvGbXsMp">
