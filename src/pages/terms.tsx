  ...
  return (
    <Layout>
      <div
        ...
        id="404"
      >
        <h2 className="text-4xl font-bold text-center text-neutral-900 dark:text-white">Terms and Conditions of Use</h2>
