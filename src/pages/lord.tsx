...
export default function LordBananow() {
  ...
  return (
    <Layout>
      <Head>
        <meta httpEquiv="Refresh" content="4; url='https://opensea.io/collection/lord-of-bananow'" />
      </Head>
      <div
      ...
      >
        ...
        <div className="mt-16 text-center">
          ...
          <Link onClick={sound2Click} href="https://opensea.io/collection/lord-of-bananow">
