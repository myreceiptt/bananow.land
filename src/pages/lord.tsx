...
export default function LordBananow() {
  ...
  return (
    <Layout>
      <Head>
        <meta
          httpEquiv="Refresh"
          content="4; url='https://opensea.io/collection/lord-of-bananow'"
        />
      </Head>
      <div
        ...
        <p className="pt-6 pb-16 text-base max-w-2xl text-center m-auto text-dark-now dark:text-white-now">
          Redirecting to Lord of{" "}
          <span className="text-green-now dark:text-yellow-now font-bold">
            BANANOW
          </span>{" "}
          NFTs collection on OpenSea.IO marketplace...
        </p>
        <Image
        ...
        <div className="mt-16 text-center">
          ...
          <Link
            onClick={sound2Click}
            href="https://opensea.io/collection/lord-of-bananow"
