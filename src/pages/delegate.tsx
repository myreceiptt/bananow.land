  ...
  return (
    <Layout>
      <Head>
        <meta
          httpEquiv="Refresh"
          content="4; url='https://bananowgp.endhonesa.com/the-ecosystem/the-crops/earlier-crops#agent-now'"
        />
      </Head>
      <div
        ...
        <p className="pt-6 pb-16 text-base max-w-2xl text-center m-auto text-dark-now dark:text-white-now">
          ...
          about how to access and empower the Farmers of{" "}
        ...
        <div className="mt-16 text-center">
          ...
          <Link
            onClick={sound2Click}
            href="https://bananowgp.endhonesa.com/the-ecosystem/the-crops/earlier-crops#agent-now"
