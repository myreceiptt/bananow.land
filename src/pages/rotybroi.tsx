...
export default function RotyBroi() {
  ...
  return (
    <Layout>
      <Head>
        <meta httpEquiv="Refresh" content="4; url='https://opensea.io/collection/the-roty-broi'" />
      </Head>
      <div
      ...
      >
        ...
        <div className="mt-16 text-center">
          ...
          <Link onClick={sound2Click} href="https://opensea.io/collection/the-roty-broi">
