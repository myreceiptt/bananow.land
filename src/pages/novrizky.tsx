...
export default function Novrizkynorman() {
  ...
  return (
    <Layout>
      <Head>
        <meta httpEquiv="Refresh" content="4; url='https://twitter.com/Novrizkynorman'" />
      </Head>
      <div
      ...
      >
        ...
        <p className="pt-6 pb-16 text-base max-w-2xl text-center m-auto text-dark-now dark:text-white-now">
          Redirecting to X account of Novrizky Norman, a farmers of <span className="text-green-now dark:text-yellow-now font-bold">BANANOW</span>...
        </p>
        <Image
          src="/images/redirects/novrizky.svg"
          alt="Novrizky Norman"
          width={1920}
          height={1080}
          quality={75}
        ...
        <div className="mt-16 text-center">
          ...
          <Link onClick={sound2Click} href="https://twitter.com/Novrizkynorman">
